//! Canonical byte representation for event hashing.
...
// What gets hashed for an event. previous_hash and current_hash are left out.
...
/// Same as chain_input_bytes but with both hashes filled in, for exports and
/// human inspection. The chain itself never hashes these.
...
/// Sort keys so the map serializes identically regardless of insertion order.
    ...
    match v {
        ...
        Value::Number(n) => {
            if let Some(i) = n.as_i64() {
                ...
                // Small fractions otherwise print like 5e-7.
...
/// Sorted map builder shared with future canonical helpers.
#[allow(dead_code)]
